...
function watchTask() {
    watch([
        ...
        series(sassTask, pugTask, assetsTask));
}

exports.default = series(parallel(pugTask, sassTask, assetsTask));
exports.serve = series(browsersyncServe, watchTask, parallel(pugTask, sassTask, assetsTask));